...
#Ploting the image on screen device
plot(timeintervals, sub_housepowercons$Global_active_power, type='l', main='', xlab='', ylab='Global Active Power (kilowatts)')

#Generating and Saving to png fomart
png(file = "plot2.png", width = 480, height = 480) ## Open PDF device; create 'plot1.png' in my working directory
plot(timeintervals, sub_housepowercons$Global_active_power, type='l', main='', xlab='', ylab='Global Active Power (kilowatts)')
