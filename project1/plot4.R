...
#Setting the drawing region 2 rows by 2 columns row wise so as accomodate 4 plots
...
with(sub_housepowercons, plot(timeintervals, Global_active_power, type='l', main='', xlab='', ylab='Global Active Power (kilowatts)'))


# make the top right plot
with(sub_housepowercons, plot(timeintervals, Voltage, type='l', main='', xlab='datetime', ylab='Voltage'))



#make the down left plot
...
#make the down right plot
with(sub_housepowercons, plot(timeintervals, Global_reactive_power, type='l', main='', xlab='datetime' ))


#Copy the plot4 from screen device to file plot4.png in working directory
dev.copy(png, file = "plot4.png") ## Copy my plot to a PNG file
dev.off()

#Restore the default drawing region parameters
par(mfcol = c(1,1))
